...
CREATE TABLE `ventas` (
  ...
  `entrega_ticket` enum('IMPRESO','CORREO') DEFAULT 'IMPRESO',
  PRIMARY KEY (`idVenta`),
...
(2,17,31,'0002','2024-04-06',1049.97,'ACTIVO','EFECTIVO','IMPRESO'),
(3,12,31,'0003','2024-04-06',2599.95,'ACTIVO','EFECTIVO','IMPRESO'),
(4,12,31,'0004','2024-04-06',1349.97,'ACTIVO','EFECTIVO','IMPRESO'),
(5,4,31,'0005','2024-04-07',2099.94,'ACTIVO','EFECTIVO','IMPRESO'),
(6,4,31,'0006','2024-04-08',1749.95,'ACTIVO','EFECTIVO','IMPRESO'),
(7,4,31,'0007','2024-04-09',1749.95,'ACTIVO','EFECTIVO','IMPRESO'),
(8,4,31,'0008','2024-04-01',799.98,'ACTIVO','EFECTIVO','IMPRESO'),
(9,4,31,'0009','2024-04-01',10999.9,'ACTIVO','EFECTIVO','IMPRESO'),
(10,3,31,'0010','2024-04-06',1899.81,'ACTIVO','EFECTIVO','IMPRESO'),
(11,3,31,'0011','2024-04-03',1999.98,'ACTIVO','EFECTIVO','IMPRESO'),
(12,3,31,'0012','2024-04-04',999.99,'ACTIVO','EFECTIVO','IMPRESO'),
(13,5,31,'0013','2024-03-06',1499.99,'ACTIVO','EFECTIVO','IMPRESO'),
(14,5,31,'0014','2024-03-06',1499.99,'ACTIVO','EFECTIVO','IMPRESO'),
(15,5,31,'0015','2024-03-06',1499.99,'ACTIVO','EFECTIVO','IMPRESO'),
(16,5,31,'0016','2024-03-07',4399.96,'ACTIVO','EFECTIVO','IMPRESO'),
(17,5,31,'0017','2024-03-08',4399.96,'ACTIVO','EFECTIVO','IMPRESO'),
(18,4,31,'0018','2024-04-06',699.98,'ACTIVO','EFECTIVO','IMPRESO'),
(19,4,31,'0019','2024-04-16',699.98,'ACTIVO','EFECTIVO','IMPRESO'),
(20,5,31,'0020','2024-03-06',5699.97,'ACTIVO','EFECTIVO','IMPRESO'),
(21,5,31,'0021','2024-03-25',699.98,'ACTIVO','EFECTIVO','IMPRESO'),
(22,14,31,'0022','2023-04-10',6749.85,'ACTIVO','EFECTIVO','IMPRESO'),
(23,25,31,'0023','2024-04-10',199.98,'ACTIVO','EFECTIVO','IMPRESO'),
(24,35,31,'0024','2024-04-10',999.99,'ACTIVO','EFECTIVO','IMPRESO'),
(25,34,31,'0025','2024-04-10',999.99,'ACTIVO','EFECTIVO','IMPRESO'),
(26,4,31,'0026','2024-04-24',12549.85,'ACTIVO','EFECTIVO','IMPRESO'),
(27,10,31,'0027','2024-04-24',36949.69,'ACTIVO','EFECTIVO','IMPRESO');
...
INSERT INTO `configuracion` VALUES ('IVA','0.16');
...
CREATE TABLE `codigos_descuento` (
  `idCodigoDescuento` int NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
--
-- Dumping data for table `codigos_descuento`
--

LOCK TABLES `codigos_descuento` WRITE;
/*!40000 ALTER TABLE `codigos_descuento` DISABLE KEYS */;
INSERT INTO `codigos_descuento` (`codigo`, `porcentaje`, `estado`, `fecha_expiracion`) VALUES
('JAGUARES', 0.10, 'ACTIVO', '2025-12-31'),
('ESTUDIANTE', 0.05, 'ACTIVO', '2025-12-31'),
('INAPAM', 0.15, 'ACTIVO', '2029-12-31');
/*!40000 ALTER TABLE `codigos_descuento` ENABLE KEYS */;
UNLOCK TABLES;