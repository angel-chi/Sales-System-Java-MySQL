...
public class SalesReportGenerator {
    ...
    public static void generateCSVReport(ObservableList<Sales> salesList, String outputPath) {
        try (FileWriter writer = new FileWriter(outputPath)) {
            ...
            MenuController.setAlert(Alert.AlertType.CONFIRMATION, "REPORTE CSV GENEREDADO CORRECTAMENTE EN  " + outputPath);

        } catch (IOException e) {
            MenuController.setAlert(Alert.AlertType.ERROR, "REPORTE CSV NO GENERADO CORRECTAMENTE: " + e.getMessage());
        }
    }
    public static void generateExcelReport(ObservableList<Sales> salesList, String outputPath) {
        try (Workbook workbook = new XSSFWorkbook()) {
            ...
            MenuController.setAlert(Alert.AlertType.CONFIRMATION, "REPORTE EXCEL GENEREDADO CORRECTAMENTE EN  " + outputPath);

        } catch (IOException e) {
            MenuController.setAlert(Alert.AlertType.ERROR, "REPORTE EXCEL NO GENERADO CORRECTAMENTE : " + e.getMessage());
        }
    }
    public static void generatePDFReport(ObservableList<Sales> salesList, String outputPath) {
        try (PDDocument document = new PDDocument()) {
            ...
            MenuController.setAlert(Alert.AlertType.CONFIRMATION, "REPORTE PDF GENEREDADO CORRECTAMENTE EN  " + outputPath);

        } catch (IOException e) {
            MenuController.setAlert(Alert.AlertType.ERROR, "REPORTE PDF NO GENERADO CORRECTAMENTE: " + e.getMessage());
