    ...
    public int IdSale(){
        ...
        try (Connection conn = DBConnection.connection();
            ...
            try (ResultSet rs = pstmt.executeQuery()){
                ...
                //Error searching IdSale ( en el comentario de abajo POR SI ACASO)
        }catch (SQLException e){
            MenuController.setAlert(Alert.AlertType.ERROR, "Error al buscar el ID de la venta: " + e.getMessage());
            return 1;
        }
    }
