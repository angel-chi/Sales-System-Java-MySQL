...
public class CustomerDAO implements CRUD<Customer> {
    ...
    public boolean update(Customer entity) {
        ...
        try(Connection conn = DBConnection.connection();
            ...
            MenuController.setAlert(Alert.AlertType.ERROR, "Error actualizando cliente: " + e.getMessage());
            return false;
        }
    }
    ...
    public void setTable(ObservableList<Customer> customers) {
        ...
        try (Connection conn = DBConnection.connection();
            ...
            MenuController.setAlert(Alert.AlertType.ERROR, "Error configurando a la tabla de clientes: " + e.getMessage());
        }
