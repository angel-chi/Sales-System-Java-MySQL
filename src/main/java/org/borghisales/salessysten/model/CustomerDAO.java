...
public class CustomerDAO implements CRUD<Customer> {
    ...
    public boolean update(Customer entity) {
        ...
        try(Connection conn = DBConnection.connection();
            ...
            if (rows_affected>0){
                ...
                MenuController.setAlert(Alert.AlertType.ERROR, "Error actualizando al cliente");
                return false;
            }

        }catch (SQLException e){
            MenuController.setAlert(Alert.AlertType.ERROR, "Error actualizando al cliente: " + e.getMessage());
            return false;
        }
    }
    ...
    public boolean delete(String id) {
        ...
        try(Connection conn = DBConnection.connection();
            ...
            if (rowsAffected > 0) {
                ...
                MenuController.setAlert(Alert.AlertType.ERROR, "Error eliminando al cliente: ");
                return false;
            }
        } catch (SQLException e) {
            MenuController.setAlert(Alert.AlertType.ERROR, "Error eliminando al cliente: " + e.getMessage());
            return false;
        }
    }
    ...
    public void setTable(ObservableList<Customer> customers) {
        ...
        try (Connection conn = DBConnection.connection();
            ...
            MenuController.setAlert(Alert.AlertType.ERROR, "Error estableciendo la tabla cliente: " + e.getMessage());
        }
