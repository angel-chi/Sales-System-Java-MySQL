...
public class ProductDAO implements CRUD<Product>{
    ...
    public boolean create(Product entity) {
        ...
        try (Connection conn = DBConnection.connection();
            ...
            if (rows_affected>0){
                MenuController.setAlert(Alert.AlertType.CONFIRMATION, "Producto agregado de manera correcta");
                return true;
            }else{
    ...
    public boolean update(Product entity) {
        ...
        try(Connection conn = DBConnection.connection();
            ...
            if (rows_affected>0){
                MenuController.setAlert(Alert.AlertType.CONFIRMATION, "Producto actualizado de manera correcta");
                return true;
            }else{
    ...
    public boolean delete(String id) {
        ...
        try(Connection conn = DBConnection.connection();
            ...
            if (rows_affected>0){
                MenuController.setAlert(Alert.AlertType.CONFIRMATION, "Producto eliminado de manera correcta");
                return true;
            }else{
            ...
            MenuController.setAlert(Alert.AlertType.ERROR, "No se puede eliminar el producto porque ya se encuentra en una venta");
            return false;
        }
    }
