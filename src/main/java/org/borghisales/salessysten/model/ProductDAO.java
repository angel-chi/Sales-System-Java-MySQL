...
public class ProductDAO implements CRUD<Product>{
    ...
    public boolean create(Product entity) {
        ...
        try (Connection conn = DBConnection.connection();
            ...
            if (rows_affected>0){
                MenuController.setAlert(Alert.AlertType.CONFIRMATION, "Producto añadidio correctamente");
                return true;
            }else{
    ...
    public boolean delete(String id) {
        ...
        try(Connection conn = DBConnection.connection();
            ...
            if (rows_affected>0){
                ...
                MenuController.setAlert(Alert.AlertType.ERROR, "Error eliminado el producto: ");
                return false;
            }
            ...
            MenuController.setAlert(Alert.AlertType.ERROR, "No puedes eliminar este producto porque ya tiene ventas registradas");
            return false;
        }
    }
    ...
    public void setTable(ObservableList<Product> products) {
        ...
        try (Connection conn = DBConnection.connection();
            ...
            MenuController.setAlert(Alert.AlertType.ERROR, "Error estableciendo la tabla: " + e.getMessage());
        }
