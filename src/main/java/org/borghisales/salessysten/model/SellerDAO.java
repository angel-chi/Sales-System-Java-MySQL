...
public class SellerDAO implements CRUD<Seller> {
    ...
    public boolean create(Seller entity) {
        ...
        try (Connection conn = DBConnection.connection();
            ...
            if (rows_affected>0){
                MenuController.setAlert(Alert.AlertType.CONFIRMATION, "Vendedor añadido correctamente");
                return true;
            }else{
                MenuController.setAlert(Alert.AlertType.ERROR, "Error añadiendo el vendedor: ");
                return false;
            }


        }catch (SQLException e){
            MenuController.setAlert(Alert.AlertType.ERROR, "Error añadiendo el vendedor: " + e.getMessage());
            return false;
        }
    ...
    public boolean update(Seller entity) {
        ...
        try(Connection conn = DBConnection.connection();
            ...
            MenuController.setAlert(Alert.AlertType.ERROR, "Error actualizando el vendedor: " + e.getMessage());
            return false;
        }
    ...
    public boolean delete(String id) {
        ...
        try(Connection conn = DBConnection.connection();
            ...
            if (rows_affected>0){
                ...
                MenuController.setAlert(Alert.AlertType.ERROR, "Error eliminado el vendedor: ");
                return false;
            }
            ...
            MenuController.setAlert(Alert.AlertType.ERROR, "Error eliminando el vendedor: " + e.getMessage());
            return false;
        }
    ...
    public void setTable(ObservableList<Seller> sellers){
        ...
        try (Connection conn = DBConnection.connection();
            ...
            MenuController.setAlert(Alert.AlertType.ERROR, "Error estableciendo la tabla de vendedores: " + e.getMessage());
        }
    }
    ...
    public static boolean login(String dni,String user){
        ...
        if (dni ==null || user ==null || dni.isEmpty()||user.isEmpty() ){
            MenuController.setAlert(Alert.AlertType.ERROR,"USUARIO o CONTRASEÑA sin llenar");
            return false;
        }
        ...
        try (Connection conn = DBConnection.connection();
            ...
            try (ResultSet rs = pstmt.executeQuery()){
                if (rs.next()){
                    ...
                    MenuController.setAlert(Alert.AlertType.ERROR, "Usuario no existe") ;
                    return false;
                }
            }
        }catch (SQLException e){
