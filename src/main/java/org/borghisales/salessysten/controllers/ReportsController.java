        ...
        tableReport.setOnMouseClicked(mouseEvent -> {
            if (!tableReport.getSelectionModel().isEmpty() && mouseEvent.getClickCount() == 2) {
                ...
                try {
                    ...
                    stage.setTitle("Detalles de ventas");
    ...
    public void onFilter(ActionEvent actionEvent) {
        ...
        try {
            ...
            if (minAmount >= maxAmount) {
                MenuController.setAlert(Alert.AlertType.ERROR,"Coloca correctamente los intervalos de venta");
                return;
            }
    ...
    public static void setCacheReportLineChart(int year, int month, XYChart.Series<String, Integer> lineChartData) {
        if (lineChartData != null) {
            ...
            if (!yearData.containsKey(month)) {
                ...
                System.out.println("Ya existe un conjunto de datos para del mes de " + month + " del año " + year + ". No se agregará un nuevo conjunto.");
            }
        } else {
            System.out.println("Error: lineChartData es nulo. No se puede añadir al mapa de caché.");
        }
        ...
        for (Integer year : cacheReportLineChart.keySet()) {
            ...
            for (Integer month : yearData.keySet()) {
                ...
                if (series != null) {
                    ...
                    System.out.println("    No hay un conjunto de datos asociados para este mes.");
                }
            }
        }
    }
