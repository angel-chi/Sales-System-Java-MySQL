...
public class ReportsController implements Initializable {
    ...
    private void setupLineChart() {
        ...
        y_amountSales.setLabel("Número de ventas");
        ...
        if (pieChartData == null) {
            ...
            pieChartData.forEach(data ->
                    data.nameProperty().bind(
                            Bindings.concat(
                                    data.getName(), " vendidos: ", (int) data.pieValueProperty().doubleValue()
                            )
                    )
            );
        }
    ...
    public void onFilter(ActionEvent actionEvent) {
        ...
        try {
            ...
            if (minAmount >= maxAmount) {
                MenuController.setAlert(Alert.AlertType.ERROR,"Ingresa valores válidos");
                return;
            }
            if (minDate.isAfter(maxDate)) {
                MenuController.setAlert(Alert.AlertType.ERROR,"Ingresa fechas válidas");
                return;
            }
