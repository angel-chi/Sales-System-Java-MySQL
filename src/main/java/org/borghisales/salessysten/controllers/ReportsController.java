...
public class ReportsController implements Initializable {
    ...
    private void setupLineChart() {
        ...
        y_amountSales.setLabel("Monto de las ventas");
    ...
    private void setupEventHandlers() {
        tableReport.setOnMouseClicked(mouseEvent -> {
            if (!tableReport.getSelectionModel().isEmpty() && mouseEvent.getClickCount() == 2) {
                ...
                MenuController.openNewStage(MainController.SALE_DETAIL_VIEW_FXML, "Detalles de la venta");
    ...
    public void onFilter(ActionEvent actionEvent) {
        ...
        try {
            ...
            if (minAmount >= maxAmount) {
                MenuController.setAlert(Alert.AlertType.ERROR,"Establecer intervalos de cantidad correctos");
                return;
            }
            if (minDate.isAfter(maxDate)) {
                MenuController.setAlert(Alert.AlertType.ERROR,"Establecer intervalos de fechas correctos");
                return;
            }
    ...
    public static void setCacheReportLineChart(int year, int month, XYChart.Series<String, Integer> lineChartData) {
        if (lineChartData != null) {
            ...
            if (!yearData.containsKey(month)) {
                ...
                System.out.println("Ya hay una serie para el año" + year + " y el mes " + month + ". No se añadirán nuevas series");
            }
        } else {
